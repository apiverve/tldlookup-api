...
```gradle
dependencies {
    implementation 'com.github.apiverve:tldlookup-api:1.1.14'
}
```
...
```java
import com.apiverve.tldlookup.TLDLookupAPIClient;
import com.apiverve.tldlookup.APIResponse;
import com.apiverve.tldlookup.APIException;

// Initialize the client
TLDLookupAPIClient client = new TLDLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("tld", "com");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/tldlookup](https://docs.apiverve.com/ref/tldlookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/tldlookup](https://docs.apiverve.com/ref/tldlookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/tldlookup-api/issues)
