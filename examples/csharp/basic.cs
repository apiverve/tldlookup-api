    ...
    class TLDLookupExample
    {
        ...
        static async Task<JsonDocument> CallTLDLookupAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;tld&quot;] &#x3D; &quot;com&quot; };
        ...
        {
            Console.WriteLine("📤 Calling TLD Lookup API...\n");

            var result = await CallTLDLookupAPI();
